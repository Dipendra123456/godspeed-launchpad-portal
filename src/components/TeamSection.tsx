  ...
  return (
    <section id="team" className="py-24 bg-[#242a38] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute top-[20%] right-[15%] w-0.5 h-48 bg-godspeed-green rotate-45 blur-sm"></div>
        <div className="absolute bottom-[30%] left-[25%] w-0.5 h-64 bg-godspeed-green -rotate-[30deg] blur-sm"></div>
      </div>
      
      {/* Glowing orb */}
      <div className="absolute top-40 left-20 w-64 h-64 rounded-full bg-godspeed-green/5 blur-3xl animate-pulse"></div>
      
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-godspeed-green/10 mb-4">
            <Star className="h-5 w-5 text-godspeed-green mr-2" />
            <span className="text-godspeed-green font-medium">Team of Experts</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-white via-godspeed-light-green to-godspeed-green bg-clip-text text-transparent">
          ...
          <p className="max-w-2xl mx-auto text-gray-300">
            ...
            to help great ideas move at <span className="font-bold text-godspeed-green">GODSPEED</span>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((member, index) => (
            <div 
              key={index} 
              className="relative group backdrop-blur-sm rounded-xl overflow-hidden border border-white/10 shadow-xl transform transition-all duration-300 hover:shadow-[0_0_30px_rgba(74,222,128,0.15)] hover:border-godspeed-green/30"
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-20 transform transition-transform duration-300 group-hover:translate-y-0">
                <div className="absolute -top-12 right-4 w-10 h-10 flex items-center justify-center rounded-full bg-godspeed-green/20 backdrop-blur-md border border-godspeed-green/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <Zap className="h-5 w-5 text-godspeed-green" />
                </div>
                <h3 className="text-xl font-semibold mb-1 text-white">{member.name}</h3>
                <p className="text-godspeed-green mb-3">{member.role}</p>
                <p className="text-gray-300 mb-4 opacity-80">{member.bio}</p>
                <a 
                  href="#" 
                  className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/10 text-gray-300 hover:bg-godspeed-green/80 hover:text-white transition-colors"
                >
        ...
        <div className="mt-12 text-center">
          <a href="#" className="inline-flex items-center text-godspeed-green hover:text-godspeed-light-green font-medium transition-colors">
            Meet the Full Team 
